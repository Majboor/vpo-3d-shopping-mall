...
const FeatureMatrix = () => (
  <section id="bp-features" className="bp-section">
    <div className="bp-container">
      ...
      <div className="bp-feat-scroll" role="region" aria-label="Feature comparison table, scroll horizontally to view all tiers" tabIndex={0}>
